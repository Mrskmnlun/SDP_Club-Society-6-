...
<head>
    ...
    <link rel="stylesheet" href="7countryEv.css">
...
<!------------------------------ HEADER ------------------------------>
    <header> 
        <a href="4countrypage.php" class="brand">APU iSocial Club</a>

        <div class="menu-btn"></div>

        <div class="navigation">
            <div class="navigation-items">
                <a href="4countrypage.php">Home</a>
                <a href="7countryEv.php">Events</a>
                <a href="7countryFe.php">Contact Us</a>
                <a href="7countryP.php">Profile</a>
...
<!------------------------------ HEADER ------------------------------>
    ...
    <table id="customers">
        ...
        <?php   
        $select = "SELECT * FROM club_events WHERE event_type = 'Country' AND status ='Accepted' ORDER BY id ASC";
                ...
                <div class="column is-10">
                  <label for="" class="labell">Select Event Name</label>
                      <div class="element"> 
                          ...
                          $query="SELECT * from club_events WHERE event_type='Country' AND status ='Accepted'"; 
