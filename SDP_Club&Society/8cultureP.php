...
<head>
    ...
    <link rel="stylesheet" href="8culturePP.css">
    <link rel="stylesheet" href="8cultureP.css">
                ...
                <div class="card h-100">
		            ...
		            <div class="row gutters">
			            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="text-right">
							<a href="4culturepage.php" button type= "submit" name="back" class="btn btn-primary">Back to mainpage</button></a>
