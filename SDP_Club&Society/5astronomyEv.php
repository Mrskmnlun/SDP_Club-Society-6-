...
<head>
    ...
    <link rel="stylesheet" href="5astronomyEv.css">
...
<!------------------------------ HEADER ------------------------------>
    <header> 
        <a href="4astronomypage.php" class="brand">APU iSocial Club</a>
        ...
        <div class="navigation">
            <div class="navigation-items">
                ...
                <a href="5astronomyP.php">Profile</a>
...
<!------------------------------ HEADER ------------------------------>
    ...
    <table id="customers">
        ...
        <?php   
        $select = "SELECT * FROM club_events WHERE event_type = 'Astronomy' AND status ='Accepted' ORDER BY id ASC";
                ...
                <div class="column is-10">
                  <label for="" class="labell">Select Event Name</label>
                      <div class="element"> 
                          ...
                          $query="SELECT * from club_events WHERE event_type='Astronomy' AND status ='Accepted' "; 
