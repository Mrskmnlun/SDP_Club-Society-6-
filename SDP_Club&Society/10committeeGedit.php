        ...
        <div class="container">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card h-100">
	                <div class="card-body">
		                <div class="row gutters">
                            ...
                            $select = "SELECT * FROM club_events_registration WHERE id='$edit_id'";
                            $run = mysqli_query($conn,$select);
                            $row_club_events_registration = mysqli_fetch_array($run);
                                $id = $row_club_events_registration['id'];
                                $event_name = $row_club_events_registration['event_name'];
                                $Login_ID = $row_club_events_registration['Login_ID'];
                                $Name = $row_club_events_registration['Name'];
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				                <div class="form-group">
					                <label for="zIp">Event Name</label>
					                <input type="text" class="form-control" value="<?php echo $event_name;?>" readonly=readonly>
				                </div>
			                </div>
			 
			                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				                <div class="form-group">
					                <label for="phone">Login_ID</label>
					                <input type="textarea" class="form-control" value="<?php echo $Login_ID;?>" readonly=readonly>
				                </div>
			                </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				                <div class="form-group">
					                ...
					                <input type="textarea" class="form-control" value="<?php echo $Name;?>" readonly=readonly>
				                </div>
			                </div>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $update =  "UPDATE club_events_registration SET status = '$estatus'
                            WHERE id='$edit_id'";
                    
                    $run_update = mysqli_query($conn,$update);
                    if ($run_update === true) {
                        echo "<script>alert('Information updated!')</script>";
                        echo "<script>window.location.href='10committeeG.php'</script>";
                    }
                    else {
