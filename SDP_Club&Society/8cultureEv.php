...
<head>
    ...
    <link rel="stylesheet" href="8cultureEv.css">
...
<!------------------------------ HEADER ------------------------------>
    ...
    <table id="customers">
        ...
        <?php   
        $select = "SELECT * FROM club_events WHERE event_type = 'Culture' AND status ='Accepted' ORDER BY id ASC";
                ...
                <div class="column is-10">
                  <label for="" class="labell">Select Event Name</label>
                      <div class="element"> 
                          ...
                          $query="SELECT * from club_events WHERE event_type='Culture' AND status ='Accepted'"; 
